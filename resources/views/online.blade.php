...
<head>
    ...
    <title>html5仿手机微信聊天界面代码</title>

    <link href="/online/css/demo.css" rel="stylesheet" media="all" />
    ...
    <script type="text/javascript" src="/online/js/jquery.qrcode.min.js"></script>
...
<div id="switcher">
    <div class="center">
        <ul>
            ...
            <li class="logoTop">
                <a href="http://www.17sucai.com/pins/23183.html">html5仿手机微信聊天界面代码</a>            <script type="text/javascript">
                jQuery('#output').qrcode({width:150,height: 150,text: window.location.href});
            </script>
            <li class="remove_frame"><a href="http://www.17sucai.com/preview/704443/2017-02-22/模拟对话框/index.html" title="移除框架"></a></li>
        </ul>
    </div>
</div>

<div id="iframe-wrap">
    <iframe id="iframe" src="http://www.17sucai.com/preview/704443/2017-02-22/模拟对话框/index.html" frameborder="0"  width="100%"></iframe>
</div>
